...
const [toggle, setToggle]= useState(false)
  ...
  {/* <button className="
    ...
    " onClick={()=>list()} type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
  aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars"
    className="svg-inline--fa fa-bars w-6" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
<Ham toggle={toggle} handleClick={list}></Ham>
...
{/* <SideBar show={toggle}></SideBar> */}
  ...
  <a className="text-gray-500 hover:text-gray-700 focus:text-gray-700 mr-4" href="#">
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shopping-cart"
      className="svg-inline--fa fa-shopping-cart w-4" role="img" xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 576 512">
      <path fill="currentColor"
  ...
  <div className="dropdown relative">
    <a className="
      ...
      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bell"
        className="svg-inline--fa fa-bell w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path fill="currentColor"
